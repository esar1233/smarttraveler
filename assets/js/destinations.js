...
function displayResults(results, budget, month) {
    ...
    for (i = 0; i < results.length; i++) {
        ...
        if (results[i].month_metric > 0) { destination_temperature = results[i].month_metric * 3; }
        ...
        destination = '<div class="destination-option">'
            ...
            + '<div class="progress round"><span class="meter temp" style="width: ' + destination_temperature + '%;"></span></div>'
